...
def calculate_intensities(movie_path, hdf5_path, inner_radius=1.5, gap_width=1,
    ...
    #yx_coords = locs.groupby(by='group').mean()[['y', 'x']].to_numpy()
...
if __name__ == '__main__':
    calculate_intensities(movie_path="G:/CAP_dwellTime_analysis/confidence_0.5/threshold_2median/20250713_CAP_library_1baseNNN/sequencing/CAP_library_1baseNNN_seq_5G_corrected.tif",
                          hdf5_path="G:/CAP_dwellTime_analysis/confidence_0.5/threshold_2median/20250713_CAP_library_1baseNNN/sequencing/localization2_corrected_picasso_bboxes.hdf5")